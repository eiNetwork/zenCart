...
// Copy attributes to duplicate product
          ...
          if ($_POST['copy_as'] == 'link') {
            ...
            $product = $db->Execute("select products_type, products_quantity, products_model, mfg_part_number, products_image,
            ...
            $db->Execute("insert into " . TABLE_PRODUCTS . "
                                      (products_type, products_quantity, products_model, mfg_part_number, products_image,
