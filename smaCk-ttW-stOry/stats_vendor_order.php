...
<?php
  ...
  $_GET['manufacturer'] = (!isset($_GET['manufacturer']) ? $mfg_dropdown[0] : $_GET['manufacturer']);
  $_GET['order_status'] = (!isset($_GET['order_status']) ? $order_stats_dropdown[0] : $_GET['order_status']);
...
<?php
  ...
  if(isset($_GET["regenerateCSV"])) {
   ...
   $headingline = "\"Product Type\",\"Category\",\"Product Model\",\"Configuration Description\",\"Config Id\",\"Qty\"";
   ...
   while (!$vendors->EOF) {
    ...
    echo "<script type='text/javascript'>window.location.href=\"/vendorOrder.csv?cachebuster=".time()."\";</script>";
...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td class="main">
        <?php
         echo zen_draw_form('new_date', FILENAME_STATS_VENDOR_ORDER, '', 'get') .
         'Manufacturer&nbsp;&nbsp;' .
   ...
   <tr>
       <table border="0" width="100%" cellspacing="2" cellpadding="2">
       <tr><?php echo zen_draw_form('search', FILENAME_STATS_VENDOR_ORDER, '', 'get');
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent" align="left"; width="9%"><?php echo TABLE_HEADING_PRODUCT_MODEL; ?>&nbsp;</td>
                <td class="dataTableHeadingContent" align="left"; width="25%"><?php echo TABLE_HEADING_CONFIG_DESC; ?>&nbsp;</td>
                <td class="dataTableHeadingContent" align="left"; width="8%"><?php echo TABLE_HEADING_CONFIG_ID; ?>&nbsp;</td>
