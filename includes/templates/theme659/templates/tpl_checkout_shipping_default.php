...
<?php echo zen_draw_form('checkout_address', zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '&products_type=' . $_GET['products_type']) . zen_draw_hidden_field('action', 'process') . zen_draw_hidden_field('products_type', $_GET["products_type"]) . (($_SESSION['selectedCartID'] == MASTER_CART) ? zen_draw_hidden_field('cart_id', $_SESSION['selectedCartID']) : ''); ?>
