...
<?php /*  Commenting out the billing address information - JLR
...
<fieldset id="checkoutOrderTotals" style="display:none">
...
?>
<fieldset class="one" style="display:none">
...
<fieldset class="two" style="display:none">
...
<!--
<fieldset class="three" style="display:none">
