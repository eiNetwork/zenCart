            ...
            if ($products_options->fields['options_values_price'] != '0' && ($products_options->fields['product_attribute_is_free'] != '1' && $product_info->fields['product_is_free'] != '1')) {
                ...
                if ($products_options->fields['product_attribute_is_free'] == '1' && $product_info->fields['product_is_free'] == '1') {
                    ...
                    if (empty($new_attributes_price)) {
                        ...
                        $products_options_display_price = ATTRIBUTES_PRICE_DELIMITER_PREFIX . $products_options->fields['price_prefix'] . $currencies->display_price($new_attributes_price, zen_get_tax_rate($product_info->fields['products_tax_class_id'])) . ($product_check->fields['payment_plan'] ? '/year' : '') . ATTRIBUTES_PRICE_DELIMITER_SUFFIX;
                    }
                }
            }
